...
const Footer =() =>(
    <div className="flex justify-center items-center flex-col sm:py-24 sm:px-20 px-1 py-10  gap-10 dark:text-[#D1D5DB]">
        <Aboutbutton title="Get in touch" />
        <p className="text-center">What’s next? Feel free to reach out to me if you're looking for <br /> a developer, have a query, or simply want to connect.</p>
