...
export default function Section1() {
  return (
    <section className="flex p-24 gap-20 flex-col-reverse md:flex md:flex-row md:p-4 md:bg-transparent dark:bg-gray-950">
      ...
      <div className="flex justify-center items-center h-[320px] min-w-[280px]">
        <img
          className="md:flex md:justify-center md:items-center p-2  dark:bg-[#374151]"
          src={photo.src}
        ></img>
      </div>
    </section>
