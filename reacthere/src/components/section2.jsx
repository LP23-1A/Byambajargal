...
export default function Section2 (){
    return(
        <section className=" relative py-24 px-20  border-3 border-solid border-black bg-gray-100  md: flex md:flex-col md:p-4 dark:bg-[#111827] dark:text-[#D1D5DB] ">
        <div className="flex flex-col gap-16 justify-center items-center">
          ...
          <div className="flex flex-col gap-24 justify-center items-center md:flex md:flex-row md:p-4">
            <img className="z-10 h-[480px] w-[400px] my-8" src={Photo2.src}></img>
        ...
        <div className="h-[480px] w-[400px] bg-[#D1D5DB]  absolute md:top-[35%] md:left-[2%] top-[13%]">
