export default function Trending(props) {
  return (
    <div className="flex flex-col w-[289px] h-[320px] gap-[20px] relative">
      <div style={{ backgroundImage:props.trendImg , backgroundSize:"cover" , backgroundRepeat:"no-repeat", backgroundColor: "rgba(255, 0, 0, 0.3)", }} className="h-80 w-72 rounded-xl">
      </div>
