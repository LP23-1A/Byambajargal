  ...
  return (
    <main className="flex flex-col gap-20 justify-center items-center py-40 bg-slate-50 ">
      ...
      <p className="text-[#3B3C4A]">
        ...
        of your travels. <br></br> One of the most rewarding aspects of traveling is
      ...
      <p className="text-[#3B3C4A]">
        ...
        confidence and avoid any cultural faux pas. <br></br> Lorem ipsum dolor sit amet,
      ...
      <p className="text-[#3B3C4A]">
        ...
        enjoy your journey. <br></br> Vitae sapien pellentesque habitant morbi tristique.
